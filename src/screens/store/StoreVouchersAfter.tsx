...
/**
 * Store details — offers+vouchers variant, after card link (Figma 1:9603, 375×968).
 * The bravo banner now confirms the linked card (استخدم بطاقتك واربح 10%) with a
 * single التفاصيل action; no bottom dock is drawn, only the floating home indicator.
 */
export default function StoreVouchersAfter({ onOfferTap }: { onOfferTap?: () => void }) {
